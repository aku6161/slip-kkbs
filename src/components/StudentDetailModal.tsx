...
interface StudentDetailModalProps {
  student: Student;
  onClose: () => void;
  onOpenDocument?: (student: Student, docType: 'surat' | 'resume' | 'bjpli' | 'skop') => void;
        ...
        <div className="space-y-6 text-xs text-slate-800 max-h-[65vh] overflow-y-auto pr-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-blue-50/70 p-4 rounded-xl border border-blue-200 space-y-2">
              ...
              <p className="font-bold text-slate-900 uppercase">{student.namaSyarikat || 'Belum Ditetapkan'}</p>
